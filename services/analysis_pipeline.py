...
def tool_run_unsupervised_model(
    ...
    outlier_mask = result.projection_plot["cluster_label"] == -1
    detected_ips = (
        result.projection_plot[outlier_mask]
...
def generate_report_markdown(
    ...
    top10_all = (
        step4.combined_top[["ipsrc", "deny_rate", "source"]].head(10).to_dict("records")
    )
    ...
    return llm_handler.query(prompt, model="mistral-small-latest")
